...
export default function TermsPage() {
  return (
    ...
    >
      <p>
        <strong className="text-graphite-900">This site:</strong> the content here is
      ...
      <p>
        <strong className="text-graphite-900">Our offers:</strong> the free audit and
      ...
      <p>
        <strong className="text-graphite-900">No guarantees:</strong> marketing results
