...
export default function TermsPage() {
  return (
    ...
    >
      <p>
        <strong className="text-mist-100">This site:</strong> the content here is
      ...
      <p>
        <strong className="text-mist-100">Our offers:</strong> the free audit and
      ...
      <p>
        <strong className="text-mist-100">No guarantees:</strong> marketing results
