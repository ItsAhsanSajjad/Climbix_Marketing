...
export default function PrivacyPage() {
  return (
    ...
    >
      <p>
        <strong className="text-mist-100">What we collect:</strong> only what you
        enter in our forms - your name, business email, website, phone, and a few
        details about your growth goals and budget range.
      </p>
      <p>
        <strong className="text-mist-100">How we use it:</strong> solely to prepare
      ...
      <p>
        <strong className="text-mist-100">Cookies &amp; tracking:</strong> we use
      ...
      <p>
        <strong className="text-mist-100">Your control:</strong> you can ask us to
